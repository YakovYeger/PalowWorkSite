...
__decorate([
    type_graphql_1.Field(() => googleUsers_1.googleUsers, { nullable: true }),
    __metadata("design:type", googleUsers_1.googleUsers)
...
let UserResolver = class UserResolver {
    ...
    login(usernameOrEmail, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield googleUsers_1.googleUsers.findOne({
    ...
    me({ req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield googleUsers_1.googleUsers.findOne(req.session.userId);
            return user;
        });
    }
};
...
__decorate([
    type_graphql_1.Query(() => googleUsers_1.googleUsers, { nullable: true }),
    __param(0, type_graphql_1.Ctx()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
UserResolver = __decorate([
    type_graphql_1.Resolver(googleUsers_1.googleUsers)
], UserResolver);
